          ...
          <a class="nav-link" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <div class="media align-items-center">
              <span class="rounded-circle">
                <img src="<?=$my_avt;?>" width="40" class="rounded-circle">
              </span>
            </div>
          </a>
            ...
            <div class=" dropdown-header noti-title">
              <div class="navi navi-spacer-x-0 pt-2">
                <h6 class="mb-0 text-center">
                  <img src="<?=$my_avt;?>" width="55" class="rounded-circle">
                </h6>
...
<?php if($my_level == 'admin') { ?>
          <li class="nav-item">
            <a class="nav-link" href="/admin/">
              <i class="ni ni-settings-gear-65"></i> PANEL ADMIN
            </a>
          </li>
<?php } ?>
        </ul>
        ...
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              <div class="media align-items-center">
                <span class="rounded-circle">
                  <img src="<?=$my_avt;?>" width="50" class="rounded-circle">
                </span>
