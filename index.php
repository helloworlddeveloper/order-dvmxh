...
?>
        <div class="col-xl-4 mt-3">
          <div class="card shadow">
            ...
            <div class="card-body">
              <div class="card">
                <a href="/order/<?=$row['code'];?>" class="btn btn-primary"> XEM THÊM</a>
              </div>
            </div>
          </div>
        </div>
...
<?php
$i = 0;
$result = mysqli_query($ketnoi,"SELECT * FROM `orders` WHERE `username` = '".$my_username."' ORDER BY id desc");
while($row = mysqli_fetch_assoc($result))
{
?>
                  <tr class="text-center">
...
<?php
$i = 0;
$result = mysqli_query($ketnoi,"SELECT * FROM `log` WHERE `username` = '".$my_username."' ORDER BY id desc");
while($row = mysqli_fetch_assoc($result)){?>
                  <tr class="text-center">
                    <td><?=$i;?></td>
                    <td><?=$row['content'];?></td>
