...
<div class="tab-content">
  <div id="taodonhang" class="tab-pane fade show active">
        <form action="" method="POST">
          ...
          <div class="form-group">
            <label class="form-control-label" for="input-email">Link Cần Tăng</label>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                ...
                <div class="modal-footer">
                  ...
                  <button type="submit" name="btnOrder" class="btn btn-primary">XÁC NHẬN</button>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="col-xl-3 order-xl-2 mb-5 mb-xl-0">
    <div class="card">
      <div class="card-body pt-0 pt-md-4">
        <div class="row align-items-center">
          <div class="col-auto">
            <img src="<?=$my_avt;?>" width="100px" height="100px" class="active avatar-home">
          </div>
...
if (isset($_POST["btnOrder"]))
{
  ...
  else if(!$money_service)
  {
    echo '<script type="text/javascript">swal("Thất Bại", "Dịch vụ không hơp lệ", "error");</script>'; 
  }
