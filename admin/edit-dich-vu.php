...
<?php
    if (isset($_POST["submit"]) && isset($_SESSION["admin"]))
    {
        ...
        $create = $ketnoi->query("UPDATE `service` SET 
          `name` = '".$name."',
          `status` = '".$status."',
          `content` = '$content',
          `limit_min` = '$limit_min',
              ...
              <div class="card-body">
               <form role="form" action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="money" value="<?=$row['money'];?>" required>
                  </div>
                  <div class="form-group">
                    <label for="exampleInputPassword1">SỐ LƯỢNG MUA TỐI THIỂU</label>
                    <input type="number" class="form-control" name="limit_min" value="<?=$row['limit_min'];?>" required>
                  </div>
                  <div class="form-group">
