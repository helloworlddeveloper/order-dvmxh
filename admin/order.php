                        ...
                        ?>
                                ...
                                <td class="text-center">
                                    <a type="button" class="btn btn-default" data-toggle="modal"
                                        data-target="#modal_<?=$row['code'];?>" class="btn btn-info"><i
                                            ...
                                            <form role="form" action="" method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<?=$row['service_name'];?>" readonly>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        value="<?=format_cash($row['amount']);?>" readonly="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">TỔNG TIỀN</label>
                                                    <input type="text" class="form-control"
                                                        value="<?=format_cash($row['money']);?>đ" readonly="">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">LINK</label>
                                                    <div class="input-group input-group">
                                                        <input type="text" class="form-control"
                                                            value="<?=$row['url'];?>" readonly="">
                                                        <span class="input-group-append">
                                                            <a type="button" href="<?=$row['url'];?>" target="_blank"
                                                                class="btn btn-info btn-flat">XEM NGAY</a>
                                                        </span>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control"
                                                        name="note_status"><?=$row['note_status'];?></textarea>
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail1">GHI CHÚ ADMIN</label>
                                                    <textarea class="form-control"
                                                        name="note_admin"><?=$row['note_admin'];?></textarea>
                                                </div>
                                        </div>
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default"
                                                data-dismiss="modal">ĐÓNG</button>
                                            <button type="submit" name="edit_<?=$row['code'];?>"
